...
<svg width="800" height="400" viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg">
  <style>
    .typing {
      ...
      font-size: 24px;
      fill: white;
      animation: typing 5s steps(12) infinite, blink 1s step-end infinite;
    }
    ...
    @keyframes typing {
      ...
      80% { content: "Hello W"; }
      85% { content: "Hello Wo"; }
      90% { content: "Hello Wor"; }
      95% { content: "Hello Worl"; }
  ...
  <!-- Background -->
  <rect width="800" height="400" fill="#1e1e2f"/>

  <!-- Girl with hijab -->
  <circle cx="200" cy="200" r="50" fill="#3b82f6"/> <!-- Hijab -->
  <circle cx="200" cy="200" r="30" fill="#fcd5ce"/> <!-- Face -->
  <rect x="170" y="250" width="60" height="40" fill="#333"/> <!-- Body -->

  <!-- Laptop -->
  <rect x="160" y="290" width="80" height="50" rx="5" ry="5" fill="#222" class="glow"/>
  <rect x="165" y="295" width="70" height="40" rx="3" ry="3" fill="#111"/>

  <!-- Typing text -->
  <text x="300" y="200" class="typing">Hello World</text>

  <!-- Java logo -->
  <circle cx="600" cy="150" r="20" fill="#f44336" class="float"/>
  <text x="590" y="155" font-size="14" fill="white" font-family="Arial">Java</text>

  <!-- Python logo -->
  <circle cx="650" cy="250" r="20" fill="#306998" class="float"/>
  <text x="638" y="255" font-size="14" fill="white" font-family="Arial">Py</text>
</svg>
